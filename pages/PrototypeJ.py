...
for feature in data.columns:
    if feature != "Baselinehistological staging":  # Exclude the target feature
        feature_values[feature] = form.number_input(f"{feature} :")
...
st.write("Predicted Target Value:", prediction[0])
